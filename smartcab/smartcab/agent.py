...
class LearningAgent(Agent):
	...
	""" The reset function is called at the beginning of each trial.
	    ...
	    once training trials hae completed. """
	...
	""" The learn function is called affter the agent completes an action and
	...
	act = action
        if action == 'None':
            act = None
        reward = self.env.act(self,act)	# Receive a reward
...
def run():
    ...
    # Flags
    #   update_delay	- continuos time (in seconds) between actions, default is 2.0 seconds
